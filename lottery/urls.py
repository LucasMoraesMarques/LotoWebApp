...
urlpatterns = [
    ...
    path("deletar-conjuntos/<int:game_set_id>", views.delete_game_sets, name="delete-game-sets"),
    path("enviar-conjuntos/<int:game_set_id>", views.send_game_sets, name="send-games-sets"),
