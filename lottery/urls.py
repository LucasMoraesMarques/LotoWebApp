...
urlpatterns = [
    ...
    path("deletar-conjuntos/<int:result_id>", views.delete_game_sets, name="delete-game-sets"),
    path("enviar-conjuntos/<int:result_id>", views.send_game_sets, name="send-game-sets"),
