...
urlpatterns = [
    ...
    path("editar-conjuntos", views.edit_games_sets, name="edit-games-sets"),
    path("enviar-conjuntos", views.send_game_sets, name="send-games-sets"),
    path("exportar-conjuntos", views.export_games_sets, name="export-games-sets"),
    path("editar-colecoes", views.edit_collections, name="edit-collections"),
    path("enviar-colecoes/", views.send_collections, name="send-collections"),
    path("exportar-colecoes", views.export_collections, name="export-collections"),
